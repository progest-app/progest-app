...
- **タイミング**: now / M3-併合 / future（事象が起きてから）
...
- タイミング: M3 import の Violation 拡張と合わせて (B-3 と一緒にやるのが理想)
...
- 候補: M3 import の integration test、watch_flow の Harness 化など。
- コスト: small
